...
// Enkel rute som hentar ut alle bilane til Halvard med personnummer 81980085
// NB: Dette er _IKKJE_ slik me gjer det til vanleg, men viser prinsippet for å hente ut noko spesifikt
app.get("/john", (req, res) => {
    const biler = db.prepare("SELECT * FROM bil WHERE personnummer = 81980085").all();
    res.json(biler);
});
...
// Besøk til dømes http://localhost:3000/bilerTil?personnummer=81980085 for å sjå alle bilane til Halvard
...
// Besøk til dømes http://localhost:3000/personer/81980085/biler for å sjå alle bilane til Halvard
